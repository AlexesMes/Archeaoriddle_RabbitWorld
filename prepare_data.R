...
f_origin_point  <- c(f_possible_origin_dat$lon, f_possible_origin_dat$lat) #Farwallow site
f_dist_org  <-  spDistsN1(f_sites, f_origin_point, longlat=TRUE) #distance from Farwallow site
...
sample_win_sp <- as.polygons(rabbithole_map > -Inf) %>% as("Spatial")
